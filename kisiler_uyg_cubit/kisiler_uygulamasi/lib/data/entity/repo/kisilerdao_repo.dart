...
class KisilerDaoRepository{
  ...
  Future<List<Kisiler>> kisileriYukle()async{
    var db=await VeriTabaniYardimcisi.veritabaniErisim();
    List<Map<String,dynamic>> maps=await db.rawQuery("SELECT * FROM kisiler");//dynamic int,string olarak değişebileceği için yazdık.
  ...
  Future<List<Kisiler>>ara(String aramaKelimesi)async{
    var db=await VeriTabaniYardimcisi.veritabaniErisim();
    List<Map<String,dynamic>> maps=await db.rawQuery("SELECT * FROM kisiler WHERE kisi_ad like '%$aramaKelimesi%'");//dynamic int,string olarak değişebileceği için yazdık.
